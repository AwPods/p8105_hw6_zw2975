...
Both distributions are normally distributed. The R squared distribution has the highest number of observations around 0.91 that has slightly less than 500 observations. The highest R squared does not exceed 0.94 and the lowest does not go lower than 0.87.
